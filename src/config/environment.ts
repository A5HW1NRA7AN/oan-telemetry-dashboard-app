...
export const KEYCLOAK_CONFIG = {
  url: getConfig().KEYCLOAK_URL || import.meta.env.VITE_KEYCLOAK_URL || "/auth", //"https://dev-auth-vistaar.da.gov.in/auth"
  realm: getConfig().KEYCLOAK_REALM || import.meta.env.VITE_KEYCLOAK_REALM || "oan-telemetry",
  clientId: getConfig().KEYCLOAK_CLIENT_ID || import.meta.env.VITE_KEYCLOAK_CLIENT_ID || "oan-telemetry-dashboard",
};

// API Configuration
export const API_CONFIG = {
  SERVER_URL: getConfig().API_SERVER_URL || import.meta.env.VITE_API_SERVER_URL || "/api/telemetry/v1",
};

// Watchtower Status API Configuration
export const WATCHTOWER_CONFIG = {
  BASE_URL: getConfig().WATCHTOWER_BASE_URL || import.meta.env.VITE_WATCHTOWER_BASE_URL || "/api",
