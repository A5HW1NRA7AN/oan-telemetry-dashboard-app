...
const TtsReport = () => {
  ...
  const stats = ttsResponse.stats ?? defaultStats;
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-center items-center p-8 bg-destructive/10 border border-destructive/20 rounded-lg">
          <div className="text-center">
            ...
            <p className="text-destructive font-medium mb-2">Error loading TTS data</p>
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Text-to-Speech synthesis call logs</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            {isLoading ? (
              <div className="flex justify-center items-center p-12 bg-muted/30 rounded-lg">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">Loading TTS data...</p>
                </div>
              </div>
            ) : ttsResponse.total === 0 ? (
              <div className="text-center py-12">
                <Volume2 className="h-12 w-12 text-muted-foreground mx-auto mb-4" />
                <p className="text-muted-foreground font-medium mb-2">No TTS records found</p>
                <p className="text-sm text-muted-foreground/80 mb-4">
                  {searchTerm || dateRange.from || dateRange.to
                    ? "Try adjusting your filters."
                    : "No TTS records are available."}
                </p>
                {(searchTerm || dateRange.from || dateRange.to) && (
            ...
            {ttsResponse.data.length > 0 && ttsResponse.totalPages > 1 && (
              <TablePagination
                currentPage={page}
                totalPages={ttsResponse.totalPages}
